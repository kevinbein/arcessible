//
//  colorVisionDeficiency_kernel.metal
//  mt-test-1
//
//  Created by Kevin Bein on 22.08.22.
//
...
constant uint phiCount = 11;
constant mat3 phisDeuteranomaly[phiCount] = {
    mat3(
...
constant mat3 phisProtanomaly[phiCount] = {
    mat3(
        1.000000, 0.000000, -0.000000,
        0.000000, 1.000000, 0.000000,
        -0.000000, -0.000000, 1.000000
...
constant mat3 phisTritanomaly[phiCount] = {
    mat3(
        1.000000, 0.000000, -0.000000,
        0.000000, 1.000000, 0.000000,
        -0.000000, -0.000000, 1.000000
...
kernel void colorVisionDeficiency_kernel(
    ...
    mat3 phi;
    if (type == 0) {
        phi = phisDeuteranomaly[severity];
    } else if (type == 1) {
        phi = phisProtanomaly[severity];
    } else {
        phi = phisTritanomaly[severity];
    }
    // https://stackoverflow.com/questions/24593939/matrix-multiplication-with-vector-in-glsl
    col.r = phi[0][0] * col.r + phi[0][1] * col.g + phi[0][2] * col.b;
    col.g = phi[1][0] * col.r + phi[1][1] * col.g + phi[1][2] * col.b;
    col.b = phi[2][0] * col.r + phi[2][1] * col.g + phi[2][2] * col.b;
